...
def main():
    ...
    base_path ='/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/BSG/data'
    
    # Load processed data
    training_segments = np.load(f'{base_path}/BCG_train.npy')
    test_segments = np.load(f'{base_path}/BCG_test.npy')
    training_labels = np.load(f'{base_path}/Corrected_peaks_train.npy')
    test_labels = np.load(f'{base_path}/Corrected_peaks_test.npy')
    ...
    output_dir = "/path/to/workspace/project-BCG-LLM/combined_data/format_data/bsg_bcg_peaks"
    ...
    # Save all datasets
    datasets = [
        ("bsg_bcg_peaks_train.json", training_examples),
        ("bsg_bcg_peaks_test.json", test_examples),
        ("bsg_bcg_peaks_combined.json", all_examples)
    ]
