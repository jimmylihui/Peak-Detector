...
def main():
    ...
    base_path ='/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/BCG_hospital'
    ...
    output_dir = "/path/to/workspace/project-BCG-LLM/combined_data/format_data/ICU_bcg_peaks"
