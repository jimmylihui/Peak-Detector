...
class DeepLearningMitbihBenchmark:
    ...
    def load_dataset(self):
        ...
        X_ECG_train,X_ECG_val,y_ECG_train,y_ECG_val = train_test_split(X_ECG_train,y_ECG_train,test_size=0.2,random_state=42)
...
def main():
    ...
    history = benchmark.train_and_evaluate(
        model_save_path='unet_plus_plus_trained_model.pt',
        epochs=epochs,
