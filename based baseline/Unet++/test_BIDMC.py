...
def calculate_heart_rate_from_peaks(peaks: np.ndarray, fs: int = 360) -> float:
	...
	# Filter RR intervals to be between 0.5 and 2 seconds
...
def main():
	...
	model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'unet_plus_plus_bidmc_trained_model.pt')
