...
class DeepLearningMitbihBenchmark:
    ...
    def load_dataset(self):
        ...
        # Reshape from (n, 10000) to (n*5, 2000)
        n_samples = X_ECG_train.shape[0]
        X_ECG_train = X_ECG_train.reshape(n_samples * 5, 2000)
        y_ECG_train = y_ECG_train.reshape(n_samples * 5, 2000)
        from sklearn.model_selection import train_test_split
...
def main():
    ...
    # Configuration
    window_length = 2000  # Non-overlapping windows of 1000 samples (Transformer requirement)
    tolerance = int(0.01*360)  # 3 positions tolerance in samples
    ...
    history = benchmark.train_and_evaluate(
        model_save_path='transformer_mitbih_trained_model.pt',
        epochs=epochs,
