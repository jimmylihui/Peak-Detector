...
class DeepLearningMitbihBenchmark:
    ...
    def load_dataset(self):
        ...
        X_PPG_train=np.load('/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/PPG_capnobase/processed/X_train.npy')
        
        y_PPG_train=np.load('/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/PPG_capnobase/processed/Y_train_gauss.npy')
...
def main():
    ...
    history = benchmark.train_and_evaluate(
        model_save_path='transformer_capnobase_trained_model.pt',
        epochs=epochs,
