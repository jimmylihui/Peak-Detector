...
class DeepLearningMitbihBenchmark:
    ...
    def load_dataset(self):
        ...
        X_BCG_train=np.load('/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/BSG/BCG_train.npy')

        #X_BCG_val=np.load('/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/BCG_Arrhythmia/X_val.npy')

        #y_BCG_val=np.load('/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/BCG_Arrhythmia/y_val.npy')



        
        y_BCG_train=np.load('/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/BSG/Corrected_peaks_train_gaussian.npy')
    ...
    def train_and_evaluate(self, model_save_path=None, epochs=100, batch_size=32, 
        ...
        history_plot_path = f'sepconv_training_history_bsg_{timestamp}.png'
        self.plot_training_history(history, history_plot_path)
        
        # Save model
        if model_save_path is None:
            model_save_path = f'sepconv_bsg_model_{timestamp}.pt'
...
def main():
    ...
    history = benchmark.train_and_evaluate(
        model_save_path='sepconv_bsg_trained_model.pt',
        epochs=epochs,
