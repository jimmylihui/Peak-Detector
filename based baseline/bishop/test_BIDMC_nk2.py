...
def process_sample(args):
    ...
    result = {'tp': 0, 'fp': 0, 'fn': 0, 'hr_error': None, 'hrv_sdnn_error': None, 'hrv_rmssd_error': None, 'hr_mape': None, 'hrv_sdnn_mape': None, 'hrv_rmssd_mape': None, 'binary_peaks': binary_peaks}
    if len(pred_peaks) > 0:
