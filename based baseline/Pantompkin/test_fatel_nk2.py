...
def process_sample(args):
    ...
    # For fatel dataset, sig is already X[i][:,1] (second column)
    ...
    result = {'tp': 0, 'fp': 0, 'fn': 0, 'hr_error': None, 'hrv_sdnn_error': None, 'hrv_rmssd_error': None, 'hr_mape': None, 'hrv_sdnn_mape': None, 'hrv_rmssd_mape': None, 'inference_time': inference_time}
    if len(pred_peaks) > 0:
...
def evaluate_fold(X_fold, y_fold, fs, tolerance_samples, detection_mode, n_cpus):
    ...
    # For fatel dataset, extract second column from X_fold
    args_list = [(i, X_fold[i][:,1], y_fold[i], fs, tolerance_samples, detection_mode) for i in range(X_fold.shape[0])]
...
def main():
    ...
    x_train_path = '/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/ECG_fatel/segments_train.npy'
    y_train_path = '/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/ECG_fatel/maternal_gaussian_train.npy'
    x_test_path = '/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/ECG_fatel/segments_test.npy'
    y_test_path = '/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/ECG_fatel/maternal_gaussian_test.npy'
