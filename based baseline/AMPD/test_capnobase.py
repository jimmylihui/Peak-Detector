...
def main():
	...
	x_test_path = '/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/PPG_capnobase/manually_clean_X_test.npy'
	y_test_path = '/path/to/workspace/project-BCG-LLM/combined_data/combined_splitted_data/PPG_capnobase/manually_clean_y_test.npy'
